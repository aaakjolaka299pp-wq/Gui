...
local BaseURL = "https://raw.githubusercontent.com/aaakjolaka299pp-wq/Gui/refs/heads/main/"
local CustomImageManager = {}
local CustomImageManagerAssets = {
    TransparencyTexture = {
        RobloxId = 139785960036434,
        Path = "Gui/assets/TransparencyTexture.png",
    ...
    SaturationMap = {
        RobloxId = 4155801252,
        Path = "Gui/assets/SaturationMap.png",
    ...
    LoadingIcon = {
        ...
        Path = "Gui/assets/LoadingIcon.png",
...
function Library:CreateWindow(WindowInfo)
    ...
    function Window:SetSidebarWidth(Width)
        ...
        if ProfileCard then
            ProfileCard.Size = UDim2.new(0, Width, 0, 56)
        end
        if ProfileTextStack then
            ProfileTextStack.Visible = Width > 80
        end
