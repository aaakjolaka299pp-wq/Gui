...
function Library:CreateWindow(WindowInfo)
    ...
    do
        ...
        do
            ...
            local function MakeBadge(icon, defaultText, color)
                ...
                table.insert(Library.Corners, New("UICorner", { CornerRadius = UDim.new(0, 4), Parent = Badge }))
                New("UIListLayout", {
                    FillDirection = Enum.FillDirection.Horizontal,
                    VerticalAlignment = Enum.VerticalAlignment.Center,
                    Padding = UDim.new(0, 4),
                ...
                table.insert(Library.Corners, New("UICorner", { CornerRadius = UDim.new(1, 0), Parent = Badge:FindFirstChildOfClass("Frame") }))
            ...
            local FpsLabel = MakeBadge("monitor", "FPS: --", Color3.fromRGB(100, 220, 120))
            local PingLabel = MakeBadge("wifi", "Ping: --", Color3.fromRGB(100, 160, 255))
            ...
            Library:GiveSignal(RunService.RenderStepped:Connect(function()
                ...
                if Now - LastTime >= 0.5 then
                    ...
                    FpsLabel.TextColor3 = FPS >= 50 and Color3.fromRGB(100, 220, 120)
                        or FPS >= 25 and Color3.fromRGB(255, 200, 60)
            ...
            Library:GiveSignal(RunService.Heartbeat:Connect(function()
                ...
                PingLabel.TextColor3 = Ping <= 80 and Color3.fromRGB(100, 220, 120)
        ...
        Tabs = New("ScrollingFrame", {
            ...
            Size = UDim2.new(0, InitialLeftWidth, 1, -126),
            Parent = MainFrame,
        })
        New("UIListLayout", {
            Parent = Tabs,
        ...
        --// User Profile Card \\--
        do
            -- line sits just above the profile card, which sits just above the 20px footer
            Library:MakeLine(MainFrame, {
                AnchorPoint = Vector2.new(0, 1),
            ...
            table.insert(Library.Corners, New("UICorner", { CornerRadius = UDim.new(1, 0), Parent = AvatarRing }))

            local AvatarInner = New("Frame", {
                AnchorPoint = Vector2.new(0.5, 0.5),
            ...
            table.insert(Library.Corners, New("UICorner", { CornerRadius = UDim.new(1, 0), Parent = AvatarInner }))

            local AvatarImg = New("ImageLabel", {
                BackgroundTransparency = 1,
                Size = UDim2.fromScale(1, 1),
                Image = string.format("rbxthumb://type=AvatarHeadShot&id=%d&w=48&h=48", LocalPlayer.UserId),
                Parent = AvatarInner,
            })
            table.insert(Library.Corners, New("UICorner", { CornerRadius = UDim.new(1, 0), Parent = AvatarImg }))
            ...
            task.defer(function()
                local Orig = Window.SetSidebarWidth
                Window.SetSidebarWidth = function(self, Width, ...)
                    Orig(self, Width, ...)
                    ProfileCard.Size = UDim2.new(0, Width, 0, 55)
                    TextStack.Visible = Width > 80
                end
            end)
        end
    ...
    function Window:SetSidebarWidth(Width)
        ...
        Tabs.Size = UDim2.new(0, Width, 1, -126)
