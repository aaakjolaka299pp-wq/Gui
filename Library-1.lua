...
function Library:CreateWindow(WindowInfo)
    ...
    do
        ...
        Tabs = New("ScrollingFrame", {
            ...
            Size = UDim2.new(0, InitialLeftWidth, 1, -118),
            Parent = MainFrame,
        })
        New("UIListLayout", {
            Parent = Tabs,
        ...
        do
            local UserProfileHolder = New("Frame", {
                AnchorPoint = Vector2.new(0, 1),
                BackgroundColor3 = "BackgroundColor",
                BorderSizePixel = 0,
                Position = UDim2.new(0, 0, 1, -70),
                Size = UDim2.new(0, InitialLeftWidth, 0, 48),
                ZIndex = 2,
                Parent = MainFrame,
            })
            ...
            Library:MakeLine(MainFrame, {
                AnchorPoint = Vector2.new(0, 1),
                Position = UDim2.new(0, 0, 1, -70 - 48),
            ...
            local AvatarImage = New("ImageLabel", {
                BackgroundTransparency = 1,
                Size = UDim2.fromScale(1, 1),
                Image = string.format("https://www.roblox.com/headshot-thumbnail/image?userId=%d&width=48&height=48&format=png", LocalPlayer.UserId),
                ZIndex = 2,
                Parent = AvatarHolder,
            })
            table.insert(
            ...
            -- Update size when sidebar width changes (compact mode)
            local OrigSetSidebarWidth
            task.defer(function()
                OrigSetSidebarWidth = Window.SetSidebarWidth
                function Window:SetSidebarWidth(Width, ...)
                    OrigSetSidebarWidth(self, Width, ...)
                    UserProfileHolder.Size = UDim2.new(0, Width, 0, 48)
                    -- hide line too
                    UserNameLabel.Visible = Width > 80
                end
            end)
        end
        ...
        do
            local ContainerBG = New("ImageLabel", {
                Image = "rbxassetid://123656803345778",
    ...
    function Window:SetSidebarWidth(Width)
        ...
        Tabs.Size = UDim2.new(0, Width, 1, -118)
